...
export const CATEGORY_SEEDS = [
  { slug: 'staples', nameEn: 'Atta & Flour', nameHi: 'आटा', icon: 'grain', tint: '#E7EDFD', iconColor: '#2456E6', sortOrder: 1 },
  { slug: 'rice', nameEn: 'Rice & Grains', nameHi: 'चावल', icon: 'rice_bowl', tint: '#DEF3E9', iconColor: '#12A36B', sortOrder: 2 },
  { slug: 'oil', nameEn: 'Oils & Ghee', nameHi: 'तेल-घी', icon: 'water_drop', tint: '#FFF1D6', iconColor: '#E8930B', sortOrder: 3 },
  { slug: 'dal', nameEn: 'Dals & Pulses', nameHi: 'दालें', icon: 'nutrition', tint: '#FFE9E3', iconColor: '#FF5436', sortOrder: 4 },
  { slug: 'spice', nameEn: 'Masale', nameHi: 'मसाले', icon: 'local_fire_department', tint: '#FDE7EC', iconColor: '#E14D6B', sortOrder: 5 },
  { slug: 'sweet', nameEn: 'Sugar & Salt', nameHi: 'चीनी-नमक', icon: 'blur_on', tint: '#E2EEFF', iconColor: '#2563EB', sortOrder: 6 },
  { slug: 'bev', nameEn: 'Tea & Beverages', nameHi: 'चाय', icon: 'emoji_food_beverage', tint: '#E2EEFF', iconColor: '#2E7DF2', sortOrder: 7 },
  { slug: 'snack', nameEn: 'Snacks', nameHi: 'नमकीन', icon: 'cookie', tint: '#FFF1D6', iconColor: '#E8930B', sortOrder: 8 },
  { slug: 'dairy', nameEn: 'Dairy', nameHi: 'डेयरी', icon: 'water_full', tint: '#D9F0F2', iconColor: '#0E9AA7', sortOrder: 9 },
  { slug: 'clean', nameEn: 'Home & Clean', nameHi: 'सफ़ाई', icon: 'cleaning_services', tint: '#DEF3E9', iconColor: '#12A36B', sortOrder: 10 },
];
...
export const PRODUCT_SEEDS: ProductSeed[] = [
  // -- Atta & Flour --
  {
    ...
    aliases: ['आटा', 'atta', 'gehu ka atta', 'wheat flour', 'ashirwad atta', 'ashirvad'],
  },
  {
    name: 'Aashirvaad Whole Wheat Atta',
    brand: 'Aashirvaad',
