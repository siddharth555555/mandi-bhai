...
export default function WholesalerHomeScreen() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Wholesaler Home</Text>
      <Text style={styles.subtitle}>
        Signed in as {user?.phone} · {user?.profiles.wholesaler?.shopName}
      </Text>
      <Text style={styles.placeholder}>Placeholder — build order/inventory flow here.</Text>
